...
public class CryptoURLTestOld {
	...
	public void canDecryptEncryptedURL() {
		...
		String actualURL = this.cryptoURL.resize(300, 200).withOldFormat().toString();
	...
	public void canEncryptWithMeta() {
		...
		assertEquals(expectedUrl, this.cryptoURL.metaDataOnly().withOldFormat().toString());
	}
	...
	public void canEncryptWithSmart() {
		...
		assertEquals(expectedUrl, this.cryptoURL.withSmartCropping().withOldFormat().toString());
	}
	...
	public void canEncryptWithFitIn() {
		...
		assertEquals(expectedUrl, this.cryptoURL.fitIn(0,0).withOldFormat().toString());
	}
	...
	public void canEncryptWitnFlipHorizontally() {
		...
		assertEquals(expectedUrl, this.cryptoURL.flipHorizontally().withOldFormat().toString());
	}
	...
	public void canEncryptWitnFlipVertically() {
		...
		assertEquals(expectedUrl, this.cryptoURL.flipVertically().withOldFormat().toString());
	}
	...
	public void canEncryptWitnHorizontalAlign() {
		...
		assertEquals(expectedUrl, this.cryptoURL.align(CryptoURL.HAlign.RIGHT).withOldFormat().toString());
	}
	...
	public void canEncryptWitnVerticalAlign() {
		...
		assertEquals(expectedUrl, this.cryptoURL.align(CryptoURL.VAlign.TOP).withOldFormat().toString());
	}
	...
	public void canEncryptWithCrop() {
		...
		assertEquals(expectedUrl, this.cryptoURL.crop(10, 20, 30, 40).withOldFormat().toString());
	}
}
